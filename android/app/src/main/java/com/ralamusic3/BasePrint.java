...
//        mPrinter.setMessageHandle(mHandle, Common.MSG_SDK_EVENT);
    ...
    public BasePrintResult setPrinterInfo() {
        getPreferences();
        Log.wtf("testprint","after get preference");
        BasePrintResult customPaperResult = setCustomPaper();
        Log.wtf("testprint","after set customPaper");
        mPrinter.setPrinterInfo(mPrinterInfo);
        Log.wtf("testprint","after set printerInfo");
...
//        }
        if (customPaperResult.success == false) {
            Log.wtf("testprint","customPaper fail");
            return customPaperResult;
        } else {
            Log.wtf("testprint","customPaper success");
    ...
    private void getPreferences() {
        ...
        Log.wtf("testprint","print info not null");
        String input;
