...
export default class ResetPasswordExpiredPage extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <View style={styles.outerView}>
        ...
        <View style={{margin:20}}>
          ...
          <Text style={styles.content}>ดูเหมือนว่าลิงค์ตั้งค่ารหัสผ่านใหม่ได้หมดอายุแล้ว หากคุณยังคงต้องการเปลี่ยนรหัสผ่าน ให้ไปกดปุ่มลืมรหัสผ่าน? จากในแอปอีกครั้งหนึ่ง</Text>          
        </View>
      </View>
    );
  }
