...
export default class OrderNoScan2Page extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleRefresh = () => 
  {
    console.log('handleRefresh OrderNoScan2Page');
  ...
  // setOrderUpdated = () => 
  // {
  //   console.log("setOrderUpdated and then should refreshList");
  ...
  newForm = () =>
  {
    console.log("new form press");
    this.props.navigation.navigate('ProductReturnForm',
    {          
  ...
  barcodeDetected(barcode)
  {
    ...
    const url =  this.state.apiPath + 'SAIMProductReturnGet.php';
